...
public class RecomendacionServiceParametrizedTest {
    ...
    private static class UsuarioDAOTestImpl implements UsuarioDAO {
        ...
        @Override public Double calcularPromedioCalificaciones(Long restauranteId) { return null; }
        @Override public List<Restaurante> buscarRestaurantesPorTipo(String tipoComida) { return null; }
        @Override public List<Restaurante> buscarRestaurantes(String busqueda) { return null; }
        @Override public Usuario findByNombreUsuario(String nombreUsuario) { return null; }
        @Override public void save(Usuario usuario) {}
        @Override public void insert(Usuario usuario) {}
        @Override public Usuario findById(Long id) { return null; }
        @Override public Comensal obtenerComensalPorId(Long id) { return null; }
