...
public class RestauranteDTO {
    ...
    public RestauranteDTO() {
        ...
        this.historias = new ArrayList<>(restaurante.getHistorias());
        this.calificaciones = new ArrayList<>(); // La clase Restaurante no tiene getter para calificaciones
        this.suscripciones = new ArrayList<>(restaurante.getSuscripciones());
        this.menuDelDia = restaurante.getMenuDelDia();
    }
